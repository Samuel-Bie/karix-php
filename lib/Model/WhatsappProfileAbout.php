...
/**
 * WhatsappProfileAbout Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WhatsappProfileAbout implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WhatsappProfileAbout';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['text']) > 139)) {
            $invalidProperties[] = "invalid value for 'text', the character length must be smaller than or equal to 139.";
        }
     ...
     * Sets text
     *
     * @param string $text The Whatsapp Business about text or status message
     *
     * @return $this
     */
    public function setText($text)
    {
        if ((mb_strlen($text) > 139)) {
            throw new \InvalidArgumentException('invalid length for $text when calling WhatsappProfileAbout., must be smaller than or equal to 139.');
        }
