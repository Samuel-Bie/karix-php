 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WhatsappTemplate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WhatsappTemplate';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rejected_reason'] === null) {
            $invalidProperties[] = "'rejected_reason' can't be null";
        }
     ...
     * Sets uid
     *
     * @param string $uid Unique ID of the Whatsapp template.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Approval status of whatsapp template. Newly created templates are in pending state until they are approved or rejected by Whatsapp.
     *
     * @return $this
     */
     ...
     *
     * @param string $whatsapp_account_uid Unique ID of the whatsapp account which owns this template
     *
     * @return $this
     */
     ...
     * Sets language_code
     *
     * @param string $language_code Language code for the template.
     *
     * @return $this
     */
     ...
     * Sets attachment
     *
     * @param string $attachment Media attachment for the template if exists. If no media is attached then the value is null.
     *
     * @return $this
     */
     ...
     * Sets text
     *
     * @param string $text Templated text or media caption for the template. Please note that a variable is represented using the placeholder {{*}} which is different from Whatsapp placeholder.
     *
     * @return $this
     */
     ...
     *
     * @param string $rejected_reason Reason given by whatsapp for rejection of the template. This field is non-null only for rejected templates.
     *
     * @return $this
     */
