 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EditMessage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EditMessage';
     ...
     * Sets redact
     *
     * @param bool $redact Set to true to redact the message. This operation cannot be undone.
     *
     * @return $this
     */
