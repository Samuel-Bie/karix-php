...
/**
 * WhatsappProfileBusiness Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WhatsappProfileBusiness implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WhatsappProfileBusiness';
     ...
     * Sets number
     *
     * @param string $number Whatsapp enabled number from your rented numbers list
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email Business Email address of the Whatsapp profile
     *
     * @return $this
     */
     ...
     * Sets address
     *
     * @param string $address Business Address of the Whatsapp profile
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description Business description of the Whatsapp profile
     *
     * @return $this
     */
     ...
     * Sets vertical
     *
     * @param string $vertical Business vertical. This value should be a valid vertical according to whatsapp documentation: https://developers.facebook.com/docs/whatsapp/api/settings/business-profile/
     *
     * @return $this
     */
     ...
     * Sets websites
     *
     * @param string[] $websites List of websites for the Business
     *
     * @return $this
     */
