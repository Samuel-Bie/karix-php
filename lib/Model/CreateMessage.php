...
class CreateMessage implements ModelInterface, ArrayAccess
{
     ...
     * Sets source
     *
     * @param string $source Sender ID for the message which will be displayed to the receiver. It should follow specification E.164 with international calling codes.   - When sending a message to US/Canada, `source` must be a number     which belongs to your Karix Subaccount (or main account).   - When sending a message over `whatsapp` channel, `source` must be the     whatsapp sandbox number from your dashboard or a Whatsapp enabled number     added to your account.
     *
     * @return $this
     */
     ...
     * Sets content
     *
     * @param object $content Content to be sent to the destinations. - For channel `sms` only `text` content is supported - For channel `whatsapp` one of either `text`, `location` or `media` is allowed
     *
     * @return $this
     */
