...
/**
 * WhatsappAccount Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WhatsappAccount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WhatsappAccount';
    ...
    protected static $setters = [
        'uid' => 'setUid',
        'name' => 'setName',
        'karix_account_uid' => 'setKarixAccountUid'
    ];
    ...
    protected static $getters = [
        'uid' => 'getUid',
        'name' => 'getName',
        'karix_account_uid' => 'getKarixAccountUid'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['karix_account_uid'] = isset($data['karix_account_uid']) ? $data['karix_account_uid'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['karix_account_uid'] === null) {
            $invalidProperties[] = "'karix_account_uid' can't be null";
        }
     ...
     * Sets uid
     *
     * @param string $uid Unique ID of the Whatsapp account
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Name of the Whatsapp Account
     *
     * @return $this
     */
    ...
    /**
     * Gets karix_account_uid
     *
     * @return string
     */
    public function getKarixAccountUid()
    {
        return $this->container['karix_account_uid'];
    }

    /**
     * Sets karix_account_uid
     *
     * @param string $karix_account_uid Unique ID of the Karix Subaccount this Whatsapp Account is attached to.
     *
     * @return $this
     */
    public function setKarixAccountUid($karix_account_uid)
    {
        $this->container['karix_account_uid'] = $karix_account_uid;
