...
/**
 * EditWhatsappProfileAbout Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EditWhatsappProfileAbout implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EditWhatsappProfileAbout';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['text']) && (mb_strlen($this->container['text']) > 139)) {
    ...
    {
        if (!is_null($text) && (mb_strlen($text) > 139)) {
            throw new \InvalidArgumentException('invalid length for $text when calling EditWhatsappProfileAbout., must be smaller than or equal to 139.');
        }
