...
class WebhookApi
{
     ...
     * @return object
     */
    public function createWebhook($api_version = '2.0', $webhook = null)
    {
     ...
     */
    public function createWebhookWithHttpInfo($api_version = '2.0', $webhook = null)
    {
        $returnType = 'object';
     ...
     */
    public function createWebhookAsync($api_version = '2.0', $webhook = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWebhookAsyncWithHttpInfo($api_version = '2.0', $webhook = null)
    {
        $returnType = 'object';
        $request = $this->createWebhookRequest($api_version, $webhook);
     ...
     */
    protected function createWebhookRequest($api_version = '2.0', $webhook = null)
    {
     ...
     * @return void
     */
    public function deleteWebhookById($uid, $api_version = '2.0')
    {
     ...
     */
    public function deleteWebhookByIdWithHttpInfo($uid, $api_version = '2.0')
    {
        $returnType = '';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteWebhookByIdAsync($uid, $api_version = '2.0')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteWebhookByIdAsyncWithHttpInfo($uid, $api_version = '2.0')
    {
        $returnType = '';
        $request = $this->deleteWebhookByIdRequest($uid, $api_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteWebhookByIdRequest($uid, $api_version = '2.0')
    {
     ...
     * @return object
     */
    public function getWebhook($api_version = '2.0', $offset = '0', $limit = '10')
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebhookWithHttpInfo($api_version = '2.0', $offset = '0', $limit = '10')
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookAsync($api_version = '2.0', $offset = '0', $limit = '10')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookAsyncWithHttpInfo($api_version = '2.0', $offset = '0', $limit = '10')
    {
        $returnType = 'object';
        $request = $this->getWebhookRequest($api_version, $offset, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWebhookRequest($api_version = '2.0', $offset = '0', $limit = '10')
    {
     ...
     * @return object
     */
    public function getWebhookById($uid, $api_version = '2.0')
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebhookByIdWithHttpInfo($uid, $api_version = '2.0')
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookByIdAsync($uid, $api_version = '2.0')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookByIdAsyncWithHttpInfo($uid, $api_version = '2.0')
    {
        $returnType = 'object';
        $request = $this->getWebhookByIdRequest($uid, $api_version);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWebhookByIdRequest($uid, $api_version = '2.0')
    {
        // verify the required parameter 'uid' is set
        if ($uid === null || (is_array($uid) && count($uid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return object
     */
    public function patchWebhook($uid, $api_version = '2.0', $webhook = null)
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchWebhookWithHttpInfo($uid, $api_version = '2.0', $webhook = null)
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchWebhookAsync($uid, $api_version = '2.0', $webhook = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchWebhookAsyncWithHttpInfo($uid, $api_version = '2.0', $webhook = null)
    {
        $returnType = 'object';
        $request = $this->patchWebhookRequest($uid, $api_version, $webhook);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function patchWebhookRequest($uid, $api_version = '2.0', $webhook = null)
    {
        // verify the required parameter 'uid' is set
        if ($uid === null || (is_array($uid) && count($uid) === 0)) {
            throw new \InvalidArgumentException(
