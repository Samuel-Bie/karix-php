...
# **createWebhook**
> object createWebhook($api_version, $webhook)
...
# **getWebhook**
> object getWebhook($api_version, $offset, $limit)
...
# **getWebhookById**
> object getWebhookById($uid, $api_version)
...
# **patchWebhook**
> object patchWebhook($uid, $api_version, $webhook)
